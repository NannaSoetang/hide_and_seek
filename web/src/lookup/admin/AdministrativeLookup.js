import { loadJson } from '../../map/shared.js'
import { geometryBounds, pointInBounds, pointInGeometry } from './geometry.js'
...
export class AdministrativeLookup {
  ...
  findInLayer(layerEntries, point) {
    for (const entry of layerEntries) {
      ...
      if (pointInGeometry(point, entry.geometry)) return entry.value
    }
    return null
  }
